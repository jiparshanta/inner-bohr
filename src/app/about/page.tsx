      ...
      <section className="relative px-6 py-16 md:py-24 lg:px-8 bg-gradient-to-b from-[#E8F5FD] to-white">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-3xl font-extrabold tracking-tight text-foreground sm:text-5xl mb-6">
            About <span className="text-primary">Ez</span>Darta
          </h1>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg mx-auto text-muted-foreground">
            <p className="text-center">
              EzDarta was founded with a simple goal: to eliminate the frustration
      ...
      <section className="py-16 md:py-24 px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value) => (
              <Card key={value.title} className="text-center shadow-sm">
                <CardContent className="pt-6">
            ...
            {team.map((member) => (
              <Card key={member.name} className="shadow-sm">
                <CardContent className="pt-6 text-center">
                  <div className="h-20 w-20 rounded-full bg-[#E8F5FD] mx-auto mb-4 flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="shadow-sm">
              <CardContent className="pt-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">info@ezdarta.np</p>
              </CardContent>
            </Card>
            <Card className="shadow-sm">
              <CardContent className="pt-6 text-center">
